...
<template>
  <header :class="['top-bar', { 'scrolled': isScrolled }]">
    <div class="top-bar-left" :class="{ 'clickable': store.currentUser }" @click="handleGoHome">
      ...
      <div class="top-bar-titles">
        ...
        <span class="top-bar-subtitle">
          <span class="marquee-track" :class="{ 'is-looping': isOverflow }" :style="isOverflow ? {
    ...
    <div class="top-bar-right">
      <button type="button" v-if="store.currentUser && !isScrolled" @click="handleLogout" class="btn-logout">
...
@keyframes marquee-loop {
  ...
  to {
    transform: translateX(var(--marquee-step));
  }
}
